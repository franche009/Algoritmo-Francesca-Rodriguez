...
function cargar() {
    ...
    for (let i=0; i<4; i++) {
        ...
        let val1 = parseFloat(prompt("Ingrese el tiempo de la vuelta 1:"));
        let val2 = parseFloat(prompt("Ingrese el tiempo de la vuelta 2:"));
        let val3 = parseFloat(prompt("Ingrese el tiempo de la vuelta 3:"));
        let tiempos = [val1, val2, val3];

        lista.push([nombre, tiempos]);
    }
