...
def cargar():
    lista = []
    for x in range(6):
        val=float(input("Ingrese la temperatura: "))
        lista.append(val)
...
[max, min] = extremos(temperaturas)

print("La máxima temperatura de las ultimas 6 horas es:", max)
print("La mínima temperatura de las ultimas 6 horas es:", min)